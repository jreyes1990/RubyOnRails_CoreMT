...
RSpec.describe "escala_precios/new", type: :view do
  before(:each) do
    assign(:escala_precio, EscalaPrecio.new(
      id_empresa: 1,
      prod_producto: nil,
  ...
  it "renders new escala_precio form" do
    render

    assert_select "form[action=?][method=?]", escala_precios_path, "post" do
