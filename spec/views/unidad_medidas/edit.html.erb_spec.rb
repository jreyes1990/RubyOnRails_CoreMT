...
RSpec.describe "unidad_medidas/edit", type: :view do
  before(:each) do
  ...
  it "renders the edit unidad_medida form" do
    render

    assert_select "form[action=?][method=?]", unidad_medida_path(@unidad_medida), "post" do
