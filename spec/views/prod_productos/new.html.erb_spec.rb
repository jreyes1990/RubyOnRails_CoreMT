...
RSpec.describe "prod_productos/new", type: :view do
  before(:each) do
    assign(:prod_producto, ProdProducto.new(
      id_empresa: 1,
      nombre: "MyString",
  ...
  it "renders new prod_producto form" do
    render

    assert_select "form[action=?][method=?]", prod_productos_path, "post" do
